    ...
    return (
      <div className='wrap'>
        ...
        <div className={'main middle container ' + (this.state.signedIn === NOT_SIGNED_IN ? '' : 'hidden')}>
          ...
          <p>You can also check out <a href="https://jayret-lang.github.io/dcic/" aria-label="Jayret book">our book that uses Jayret</a> or <a href="http://www.bootstrapworld.org" aria-label="Bootstrap curricula">our curricula</a>.</p>
